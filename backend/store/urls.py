...
from .views import ItemPurchaseView, InventoryView, DecorationItemView, ItemListView, UserCoinView
...
urlpatterns = [
    ...
    path("users/coins/", UserCoinView.as_view(), name="user-coin"),                             # 코인 추가
]
