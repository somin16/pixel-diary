...
from .views import ProfileView, AttendanceView, AttendanceResetView
...
urlpatterns = [
    ...
    path("attendance/reset/", AttendanceResetView.as_view(), name="attendance-reset"),   # 출석 기록 초기화 (만료 시)
]
