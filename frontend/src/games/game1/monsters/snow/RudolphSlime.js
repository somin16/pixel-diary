...
export default class RudolpSlime extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor(scene, x, y, monsterStatus) {
        ...
        this.monsterID = 14;           // 몬스터 번호
        this.hp = 18 + monsterStatus;  // 체력
        this.damage = -4;              // 대미지
        ...
        this.play("rudolph_slime_move_animation", true);
    }
    ...
    move(player) { // 매게변수 플레이어
        ...
        // 이동속도
        this.scene.physics.moveToObject(this, player, 75);
