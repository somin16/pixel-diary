...
export default class SantaSlime extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor(scene, x, y, monsterStatus) {
        ...
        this.play("santa_slime_move_animation", true);
    }
    ...
    move(player) { // 매게변수 플레이어
        ...
        // 이동속도
        this.scene.physics.moveToObject(this, player, 68);
