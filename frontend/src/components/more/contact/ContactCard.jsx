  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-[2%]">
        <span className="text-[11px] font-bold text-blue-600 bg-blue-50/80 px-[2%] py-[0.5%] rounded border border-blue-100 whitespace-nowrap shrink-0">
          {item.category}
        </span>

        <div className="flex items-center">
          <span className={`relative inline-block text-[11px] font-bold whitespace-nowrap shrink-0 ${item.status === 'resolved' ? 'text-green-600' : 'text-amber-600'}`}>
        ...
        <div className="mt-[3%] pt-[3%] border-t border-gray-200/60 text-[12px] text-gray-600 space-y-[3%] animate-fadeIn">
          ...
          {item.status === 'resolved' && item.reply ? (
            <div className="bg-blue-50/60 p-[3%] rounded border-l-4 border-blue-400">
              <p className="font-bold text-blue-700 text-[11px] m-[0%] mb-[1%]">👑 관리자 답변</p>
