 ...
 * @param {string} textSize - 버튼의 글씨 크기 조정
 * @param {string} textColor - 버튼의 글씨 색상 조정
 */

const ImageButton = ({ label, onClick, imageSrc, className, textSize, textColor }) => {
  return (
    ...
    >
      ...
      <span 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 whitespace-nowrap"
        style={{ fontSize: textSize || '13px', color: textColor || 'white' }}
      >
        {label}
      </span>
    </button>
